...
class SettingsController extends Controller {
	 ...
	 */
	public function __construct($appName, IRequest $request, IUser $user, IURLGenerator $urlGenerator, IL10N $l10n, AliasManager $aliasManager, IUserManager $userManager) {
